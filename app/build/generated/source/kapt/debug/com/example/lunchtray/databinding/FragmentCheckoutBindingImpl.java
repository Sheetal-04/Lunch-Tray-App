...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.checkoutFragement == variableId) {
            setCheckoutFragement((com.example.lunchtray.ui.order.CheckoutFragment) variable);
        }
    ...
    public void setCheckoutFragement(@Nullable com.example.lunchtray.ui.order.CheckoutFragment CheckoutFragement) {
        this.mCheckoutFragement = CheckoutFragement;
        synchronized(this) {
            mDirtyFlags |= 0x40L;
        }
        notifyPropertyChanged(BR.checkoutFragement);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.CheckoutFragment checkoutFragement = mCheckoutFragement;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            case 1: {
                ...
                // checkoutFragement
                com.example.lunchtray.ui.order.CheckoutFragment checkoutFragement = mCheckoutFragement;
                // checkoutFragement != null
                boolean checkoutFragementJavaLangObjectNull = false;



                checkoutFragementJavaLangObjectNull = (checkoutFragement) != (null);
                if (checkoutFragementJavaLangObjectNull) {


                    checkoutFragement.submitOrder();
                }
                break;
            }
            case 2: {
